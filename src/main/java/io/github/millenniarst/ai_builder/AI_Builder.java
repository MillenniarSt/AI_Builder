package io.github.millenniarst.ai_builder;
...
public class AI_Builder extends JavaPlugin {

	public static final String NAME = "AI_Builder";
	private static AI_Builder plugin;
	...
	public void onEnable() {
		...
		System.out.println(ChatColor.GREEN + "AI_Builder plugin enabled successfully");
	}
	...
	public static AI_Builder getPlugin() {
		return plugin;
	}
